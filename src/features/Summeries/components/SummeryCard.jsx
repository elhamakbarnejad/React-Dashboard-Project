const SummeryCard = ({ h1Title, pTitle, btn1Title, btn2Title }) => {
  return (
    <div className=" bg-sky-200/30 rounded-xl flex flex-col items-center justify-between h-full text-center p-5 hover:-translate-y-0.5 transition-all duration-150">
      ...
      <div className="flex items-center justify-between w-full gap-2 p-5">
        <button className="w-1/2 bg-white rounded-xl px-2 py-1 text-sm shadow hover:-translate-y-0.5 transition-all duration-150">
          {btn1Title}{" "}
        </button>
        <button className="w-1/2 bg-white rounded-xl px-2 py-1 text-sm shadow hover:-translate-y-0.5 transition-all duration-150">
          {btn2Title}
